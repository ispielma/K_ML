...
from user_devices.Arduino_TEC_Control.labscript_user_devices import Arduino_TEC_Control
...
ls.DigitalOut(name="D2_SatSpec_DO", parent_device=PB0.direct_outputs, connection='flag 0')
...
ls.DigitalOut(name='D2_Repump_Img_Sh', parent_device=NI_PCI_01, connection='port0/line2')
...
ls.AnalogOut(name='D2_SatSpec_FM', parent_device=NI_PCI_02, connection='ao4',
             unit_conversion_class=IntraAction.IntraAction_FM,
             unit_conversion_parameters={'f_0': D2_Lock_Shift_UC_f0, 
                                         'MHz_per_V': D2_Lock_Shift_UC_MHz_per_V}
             )
...
ls.AnalogOut(name='ni_usb_01_ao3', parent_device=NI_USB_01, connection='ao3',
             unit_conversion_class=CurrentSupply.CurrentSupplyGradient,
             unit_conversion_parameters={'A_per_V': Ch4_UC_A_per_V,
                                         'G_per_cm_per_V': Ch4_UC_G_per_cm_per_V}
             )
...
ls.DigitalOut(name='ni_usb_01_ao3_Disable', parent_device=NI_USB_01, connection='port0/line3')
...
ls.AnalogOut(name='MOT_Quad', parent_device=NI_USB_02, connection='ao0',
             unit_conversion_class=CurrentSupply.CurrentSupplyGradient,
...
ls.DigitalOut(name='FourChan_A_Bit0', parent_device=NI_USB_02, connection='port0/line0')
ls.DigitalOut(name='FourChan_A_Bit1', parent_device=NI_USB_02, connection='port0/line1')
ls.DigitalOut(name='FourChan_A_Enable', parent_device=NI_USB_02, connection='port0/line2')
...
Basler_camera_imaqdx_attributes = {
    ...
    'CameraAttributes::AnalogControls::BlackLevelRaw': 200,
    'CameraAttributes::AnalogControls::DigitalShift': 0,
    'CameraAttributes::AnalogControls::GainAuto': 'Off',
    'CameraAttributes::AnalogControls::GainRaw': 100, # 100-600 allowed
...
Mako_camera_imaqdx_attributes = {
    ...
    'CameraAttributes::Acquisition::AcquisitionFrameRateAbs': 228,
...
#    'CameraAttributes::Controls::Exposure::ExposureTimeAbs': 15000.0,
    ...
    'CameraAttributes::GigE::StreamFrameRateConstrain': 0,
...
Mako_manual_mode_imaqdx_attributes = {
 ...
 # Two FL cameras
Mako_FlCameras_mode_imaqdx_attributes = Mako_camera_imaqdx_attributes.copy()
Mako_FlCameras_mode_imaqdx_attributes['CameraAttributes::GigE::StreamBytesPerSecond'] //= 2
Mako_FlCameras_mode_imaqdx_attributes['CameraAttributes::Acquisition::AcquisitionFrameRateAbs'] //= 2

# Slow down Basler too
Basler_camera_imaqdx_attributes['CameraAttributes::AcquisitionTrigger::AcquisitionFrameRateAbs'] //= 2
...
IMAQdxCamera(name='MOT_x',
    ...
    camera_attributes=Mako_FlCameras_mode_imaqdx_attributes,
...
Arduino_TEC_Control( name = 'Arduino_TEC_Control',
          addr='ASRL9::INSTR', 
          timeout = 10)
